 ...
 * It also includes an implementation of the display() function to output the details of a dish to the standard output, 
 * and operator overloads for the == and != operators.
