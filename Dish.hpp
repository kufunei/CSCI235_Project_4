 ...
 * It provides constructors, destructor, accessor and mutator functions, a pure virtual dietaryAdjustment function 
 * and a virtual display function to manage and present the details of a dish.
 * 
